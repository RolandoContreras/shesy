!function(e, t) {
	...
	function E(e, t, n, o, i) {
		for (var a, s, l, c, u, f, p = t.createDocumentFragment(), d = [], h = 0, m = e.length; h < m; h++) if ((a = e[h]) || 0 === a) if ("object" === r(a)) xe.merge(d, a.nodeType ? [a] : a);
		else if (Ze.test(a)) {
	...
	function O(e, t, r, o) {
		...
		if (p && (i = E(t, e[0].ownerDocument, !1, e, o), a = i.firstChild, 1 === i.childNodes.length && (i = a), a || o)) {
			...
			if (l) for (u = s[s.length - 1].ownerDocument, xe.map(s, N), f = 0; f < l; f++) c = s[f], Qe.test(c.type || "") && !Xe.access(c, "globalEval") && xe.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? xe._evalUrl && xe._evalUrl(c.src) : n(c.textContent.replace(st, ""), u, c))
		}
		return e
	}
	function W(e, t, n) {
	...
	xe.fn = xe.prototype = {
		...
		var e, t, n, r, o, i, a = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || ye(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], a !== (r = e[t]) && (c && r && (xe.isPlainObject(r) || (o = Array.isArray(r))) ? (o ? (o = !1, i = n && Array.isArray(n) ? n : []) : i = n && xe.isPlainObject(n) ? n : {}, a[t] = xe.extend(c, i, r)) : void 0 !== r && (a[t] = r));
		return a
	}, xe.extend({
	...
	var Ee = function(e) {
		...
		function p(e, t, n) {
			...
			function(t, n, o) {
				...
				for (; t = t[r];) if (1 === t.nodeType || a) if (f = t[Y] || (t[Y] = {}), u = f[t.uniqueID] || (f[t.uniqueID] = {}), o && o === t.nodeName.toLowerCase()) t = t[r] || t;
				else {
		...
		function v(e) {
			for (var t, n, r, o = e.length, i = x.relative[e[0].type], a = i || x.relative[" "], s = i ? 1 : 0, l = p(function(e) {
				...
				return t = null, o
			}]; s < o; s++) if (n = x.relative[e[s].type]) u = [p(d(u), n)];
			else {
			...
			var o = n.length > 0,
				...
				a = function(r, a, s, l, c) {
					...
					for (c && (k = a === H || a || c); h !== T && null != (u = b[h]); h++) {
						if (i && u) {
							for (f = 0, a || u.ownerDocument === H || (N(u), s = !O); p = e[f++];) if (p(u, a || H, s)) {
								l.push(u);
								break
							}
							c && (q = w)
		...
		w = t.support = {}, E = t.isXML = function(e) {
			...
			}), W = W.length && new RegExp(W.join("|")), R = R.length && new RegExp(R.join("|")), t = he.test(j.compareDocumentPosition), P = t || he.test(j.contains) ?
			function(e, t) {
					...
					function(e) {
						...
						if (g) {
							...
							if (h = [a ? g.firstChild : g.lastChild], a && y) {
								for (b = (d = (c = (u = (f = (p = g)[Y] || (p[Y] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === q && c[1]) && c[2], p = d && g.childNodes[d]; p = ++d && p && p[m] || (b = d = 0) || h.pop();) if (1 === p.nodeType && ++b && p === t) {
									u[e] = [q, d, b];
									break
								}
							} else if (y && (b = d = (c = (u = (f = (p = t)[Y] || (p[Y] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === q && c[1]), !1 === b) for (;
		...
		return u.prototype = x.filters = x.pseudos, x.setFilters = new u, S = t.tokenize = function(e, n) {
			...
			if (n = n || [], 1 === p.length) {
				...
				for (o = fe.needsContext.test(e) ? 0 : i.length; o-- && (a = i[o], !x.relative[s = a.type]);) if ((l = x.find[s]) && (r = l(a.matches[0].replace(ve, ye), ge.test(i[0].type) && c(t.parentNode) || t))) {
	...
	(xe.fn.init = function(e, t, n) {
		...
		if (n = n || De, "string" == typeof e) {
			...
			if (r[1]) {
				if (t = t instanceof xe ? t[0] : t, xe.merge(this, xe.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : ae, !0)), ke.test(r[1]) && xe.isPlainObject(t)) for (r in t) ye(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
				return this
			}
	...
	xe.fn.extend({
		...
		closest: function(e, t) {
			...
			if (!Le.test(e)) for (; r < o; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && xe.find.matchesSelector(n, e))) {
				i.push(n);
				break
			}
	...
	xe.event = {
		...
		add: function(e, t, n, r, o) {
			...
			if (g) for (n.handler && (n = (i = n).handler, o = i.selector), o && xe.find.matchesSelector(et, o), n.guid || (n.guid = xe.guid++), (l = g.events) || (l = g.events = {}), (a = g.handle) || (a = g.handle = function(t) {
		...
		remove: function(e, t, n, r, o) {
			...
			if (g && (l = g.events)) {
				for (c = (t = (t || "").match(je) || [""]).length; c--;) if (s = rt.exec(t[c]) || [], d = m = s[1], h = (s[2] || "").split(".").sort(), d) {
	...
	xe.extend({
		...
		clone: function(e, t, n) {
			...
			if (t) if (n) for (i = i || x(e), a = a || x(s), r = 0, o = i.length; r < o; r++) H(i[r], a[r]);
			else H(e, s);
			return (a = x(s, "script")).length > 0 && T(a, !l && x(e, "script")), s
		},
		
		cleanData: function(e) {
			for (var t, n, r, o = xe.event.special, i = 0; void 0 !== (n = e[i]); i++) if (Ye(n)) {
				if (t = n[Xe.expando]) {
	...
	xe.fn.extend({
		...
		addClass: function(e) {
			...
			if ((t = J(e)).length) for (; n = this[l++];) if (o = Q(n), r = 1 === n.nodeType && " " + G(o) + " ") {
	...
	for (var G = Math.min, Q = Math.floor, J = Math.round, Z = Math.max, ee = "undefined" != typeof window && "undefined" != typeof document, te = ["Edge", "Trident", "Firefox"], ne = 0, re = 0; re < te.length; re += 1) if (ee && 0 <= navigator.userAgent.indexOf(te[re])) {
		ne = 1;
		break
	}
	...
	function n(n) {
		...
		if (O && (n.wheelDeltaX && h(n.wheelDeltaX, 120) && (a = n.wheelDeltaX / Math.abs(n.wheelDeltaX) * -120), n.wheelDeltaY && h(n.wheelDeltaY, 120) && (l = n.wheelDeltaY / Math.abs(n.wheelDeltaY) * -120)), a || l || (l = -n.wheelDelta || 0), 1 === n.deltaMode && (a *= 40, l *= 40), !L.touchpadSupport &&
		function(e) {
	...
	var q, I, B = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame ||
	function(e, t, n) {
	...
	T.prototype.eventElement = function(e) {
		...
		k = function(r, o) {
			...
			this.isRtl = "" === e(r).direction, this.isNegativeScroll = function() {
				var e = r.scrollLeft,
					t = null;
