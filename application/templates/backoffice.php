...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo site_url() . 'static/backoffice/css/my_style.css'; ?>">
        <style>
...
<?php echo $body; ?>
            ...
            <script>
                ...
                $(function () {
                    $('[data-toggle="popover"]').popover({html: true, trigger: 'manual', container: $(this).attr('id'), placement: "top", content: function () {
                            $return = '<div class="hover-hovercard" data-placement="top"></div>';
