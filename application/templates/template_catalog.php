...
<html lang="es">
    <head>
        <title>Catalogo de Productos - Cultura Emprendedora</title>
        ...
        <!--//CUSTOMER CSS-->
        <link rel="stylesheet" href="<?php echo site_url() . 'static/catalog/css/my_style.css'; ?>">
        <link rel="stylesheet" href="<?php echo site_url() . 'static/catalog/css/gallery.css'; ?>">
        <link rel="stylesheet" href="<?php echo site_url() . 'static/catalog/css/ekko-lightbox.min.css'; ?>">
        <link rel="stylesheet" href="<?php echo site_url() . 'static/catalog/css/lightbox.min.css'; ?>">
        <link rel="stylesheet" href="<?php echo site_url() . 'static/catalog/css/dark.css'; ?>">
