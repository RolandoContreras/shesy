...
class publicity_catalog_model_atributos{	
    var $kit_id='';
    var $name='';
    var $price='';
    var $point='';
...
class Publicity_catalog_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'publicity_catalog';
	    $this->table_id = 'id';
        $this->id='';
        $this->customer_id='';
        $this->catalog_id='';
        ...
        $this->date='';
	    $this->status='';
	    $this->fields = new publicity_catalog_model_atributos();
    }   
