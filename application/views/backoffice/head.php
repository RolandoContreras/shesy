<head>
        ...
        <!--[if lt IE 11]><script src="https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js"></script><script src="https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js"></script><![endif]-->
        <meta charset="utf-8">
        ...
        <meta name="copyright" content="Evolucion Web" />
        <link rel="stylesheet" href="<?php echo site_url().'static/backoffice/css/animate.min.css';?>">
        <link rel="stylesheet" href="<?php echo site_url().'static/backoffice/css/style.css';?>">
        <link rel="stylesheet" href="<?php echo site_url().'static/backoffice/css/mystyle.css';?>">
        <link rel="stylesheet" href="<?php echo site_url().'static/backoffice/css/dropzone.css';?>" >
