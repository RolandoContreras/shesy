<head>
  ...
  <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/autoptimize_6e.css';?>" type="text/css" media="none" onload="if(media!='all')media='all'">
    <!--//STAR FAVICON-->
    ...
    <!--//END FAVICON-->
  <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/dashicons.min.css';?>" type="text/css" media="none" onload="if(media!='all')media='all'">
  <link rel="stylesheet" href="<?php echo site_url().'static/page_front/css/mystyle7.css';?>" type="text/css" media="none" onload="if(media!='all')media='all'">
