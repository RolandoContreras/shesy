...
<!--                        <input name="pass" id="pass" class="form-control" placeholder="Contraseña" type="password" autocomplete="off" required="">
                    ...
                    <div class="form-group">
                        <label>Nombres</label>
                        <input name="name" id="name" class="form-control" placeholder="Nombres" type="text" autocomplete="off" required="">
                        <div class="pre-icon os-icon"><i class="fa fa-address-book"></i></div>
                    </div>
                    <div class="form-group">
                        <label>Apellidos</label>
                        <input name="last_name" id="last_name" class="form-control" placeholder="Apellidos" type="text" autocomplete="off" required="">
                        <div class="pre-icon os-icon"><i class="fa fa-user"></i></div>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input name="email" id="email" class="form-control" placeholder="Email" type="email" autocomplete="off" required="">
                        <div class="pre-icon os-icon "><i class="fa fa-envelope-open"></i></div>
                    </div>
                    <div class="form-group">
                        <label>DNI / Cedula</label>
                        <input name="dni" id="dni" class="form-control" placeholder="DNI / Cedula" type="text" autocomplete="off" required="">
                        <div class="pre-icon os-icon "><i class="fa fa-id-card"></i></div>
                    </div>
                    <div class="form-group">
                        <label>Teléfono</label>
                        <input name="phone" id="phone" class="form-control" placeholder="Teléfono" type="text" autocomplete="off" required="">
                        <div class="pre-icon os-icon "><i class="fa fa-phone"></i></div>
                    </div>
                    <div class="form-group">
                        <label>Dirección</label>
                        <input name="address" id="address" class="form-control" placeholder="Dirección" type="text" autocomplete="off" required="">
