                                        ...
                                        <li>
                                            <span id="productPrice-product-template" class="h1">
                                                <span aria-hidden="true">
                                                    <span class="money conversion-bear-money" style="color: #c9d0d5 !important;">&dollar;<?php echo $obj_catalog->price; ?></span>
                                                </span>
                                            </span>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="product-description rte">
                                        ...
                                        <div class="row">
                                            <?php foreach ($obj_catalog_rand as $value) { ?>
                                                <div class="col-md-6">
                                                    <a href="<?php echo site_url() . "catalogo/$value->category_slug/$value->catalog_id/$value->slug"; ?>" class="card section--dark" style="text-align: left;background: rgb(33, 34, 36);">
