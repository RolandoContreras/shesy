    ...
    <main>
        <div data-content-for-index data-dynamic-sections="index">
                    ...
                    <div class="sizer">
                        <div class="container">
                            ...
                            <div  class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="<?php echo site_url() . "static/page_front/video/cultura.mp4";?>" frameborder="0" allowfullscreen></iframe>
                            </div>
                        </div>
                    </div>
            ...
            <div id="section-1593557264926">
                <div kjb-settings-id="sections_1593557264926_settings_background_color" class="section background-dark"
                                ...
                                <div id="block-1594661185857" class="block-type--image text- col-12 animated">
                                    <div class="block box-shadow-none background-unrecognized" data-aos="fade-up" data-aos-delay="0" data-aos-duration="0">
                                        <div class="image">
                                            ...
                                            <div class="space-20"></div>
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <iframe class="embed-responsive-item" src="<?php echo site_url() . "static/page_front/video/embajada.mp4";?>" frameborder="0" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
