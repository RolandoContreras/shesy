            ...
            <div class="content container">
              <div class=row>
                ...
                <div class="text-description col-md-6">
                  <div class=banner-description><strong class="br">Lo mejor en educación</strong>Comunícate con nosotros y permítenos ayudarte.</div>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-12">
                      <div class=vc_column-inner>
                        <div class=wpb_wrapper>
                          <div class="vc_row wpb_row vc_inner vc_row-fluid thim-max-width-lg">
                            <div class="wpb_column vc_column_container vc_col-sm-4">
                              <div class=vc_column-inner>
                                <div class=wpb_wrapper>
                                  <div class="thim-sc-icon-box layout-5 default">
                                    <div class=icon-box-wrapper style>
                                      <div class=box-icon>
                                          <i class="fa fa-street-view" aria-hidden="true"></i>
                                      </div>
                                      <div class=box-content>
                                        <h3 class="title">UBÍCANOS</h3>
                                        <div class=description>
                                          <p>Av. Benavides 2191 <br>Lima, Perú.</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="thim-sc-icon-box layout-5 default">
                                    <div class=icon-box-wrapper style>
                                      ...
                                      <div class=box-content>
                                        ...
                                        <div class=description>
                                          <p>Teléfono:<a> (+51) 242 8210</a><br>Movil: (+51) 999 444 555</p>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
          ...
          <div class=wpb_wrapper>
            <div class="thim-sc-heading text-center layout-2 ">
              <div class=heading-content>
                <h3 class="primary-heading">Dejar un mensaje</h3>
              </div>
              <p class=secondary-heading>Su dirección de correo electrónico no se publicará. Los campos obligatorios están marcados.</p><span class=underline></span></div>
          </div>
        </div>
      </div>
    </div>
