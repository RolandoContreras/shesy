  ...
  <div id="main-content">
    <section class=content-area>
      <div class="page-title layout-1">
        <div class="main-top no-parallax" style="background-image:url(<?php echo site_url().'static/page_front/images/background_2.jpg';?>)">
                      ...
                      <li class="col-xs-6 col-md-3 col-sm-6 first product-card post-846 product type-product status-publish has-post-thumbnail product_cat-accessories product_cat-cookware product_cat-culinary product_cat-postcard pmpro-has-access  instock sale shipping-taxable purchasable product-type-simple">
                        <div class=wrapper>
                          <div class=feature-image>
                            ...
                            <a href='<?php echo site_url()."catalogo/$value->category_slug/$value->catalog_id/$value->slug";?>'>
                        ...
                        <div class="product-content">
                            <div class="title-product">
                                <a href="<?php echo site_url()."catalogo/$value->category_slug/$value->catalog_id/$value->slug";?>" class="product_name"><?php echo $value->name;?></a></div>
                                    <span class="price">
