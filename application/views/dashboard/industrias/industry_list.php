            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <div class="page-header-title">
                  <h5 class="m-b-10">Mantenimientos de Industrias</h5>
                </div>
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url().'dashboard/';?>">Panel</a></li>
                  <li class="breadcrumb-item"><a>Industrias</a></li>
                </ul>
              </div>
            </div>
          </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <button class="btn btn-secondary" type="button" onclick="new_industry();"><span><span class="pcoded-micon"><i data-feather="plus"></i></span> Nueva Industria</span></button>
                  </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" role="grid"
                              ...
                              <thead>
                                <tr role="row">
                                  <th class="sorting_asc" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending">ID</th>
                                  <th class="sorting" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">Nombre</th>
                                    <th class="sorting" tabindex="0" aria-controls="zero-configuration" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">Tipo</th>
                              ...
                              <tbody>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-icon btn-danger" onclick="delete_industry('<?php echo $value->id;?>')"><i class="fa fa-trash"></i></button>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach; ?>
