                    ...
                    <form enctype="multipart/form-data" method="post" action="<?php echo site_url()."dashboard/bonos/validate";?>">
                        <div class="form-row">
                          <div class="form-group col-md-6">
                              ...
                              <div class="form-group">
                                <label>Nombre</label>
                                <input class="form-control" type="text" id="name" name="name" value="<?php echo isset($obj_bonus->name)?$obj_bonus->name:"";?>" class="input-xlarge-fluid" placeholder="Name">
                              </div>
                          ...
                          <div class="form-group col-md-6">
                              <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="percent" name="percent" value="<?php echo isset($obj_bonus->percent)?$obj_bonus->percent:"";?>" class="input-xlarge-fluid" placeholder="Porcentaje">
                              </div>
                              <div class="form-row">
