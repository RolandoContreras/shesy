              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <button class="btn btn-secondary" type="button" onclick="new_bono();"><span><span class="pcoded-micon"><i data-feather="plus"></i></span> Nuevo</span></button>
                  </div>
                            ...
                            <table id="zero-configuration" class="display table nowrap table-striped table-hover dataTable" style="width: 100%;" role="grid"
                              ...
                              <tbody>
                                ...
                                <td>
                                    <div class="operation">
                                            <div class="btn-group">
                                               <button class="btn btn-secondary" type="button" onclick="edit_bonus('<?php echo $value->bonus_id;?>');"><span><span class="pcoded-micon"><i data-feather="edit"></i></span> Editar</span></button>
                                            </div>
                                    </div>
                                </td>
                            </tr>
