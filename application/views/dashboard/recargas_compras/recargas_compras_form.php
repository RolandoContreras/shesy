          ...
          <div class="page-block">
            <div class="row align-items-center">
              <div class="col-md-12">
                ...
                <ul class="breadcrumb">
                  <li class="breadcrumb-item"><a href="<?php echo site_url().'dashboard/recargas_compras';?>">Listado de Recargas</a></li>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                      <form enctype="multipart/form-data" action="javascript:void(0);" onsubmit="recargar_compra();">
                        <div class="form-row">
                              ...
                              <div class="form-group">
                                  <label for="inputState">Estado</label>
                                        <select name="active" id="active" class="form-control" required>
                                            <option value="1" selected>Abonado</option>
                                        </select>
                              </div>
                        </div>
                        <button class="btn btn-primary">Guardar</button>
                        <button class="btn btn-danger" type="reset" onclick="cancel_recargas_compras();">Cancelar</button>                    
                        </div>
                    </form>
                </div>
            </div>
