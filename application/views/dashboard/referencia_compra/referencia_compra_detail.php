        ...
        <div>
            ...
            <div class="card-block">
              <div class="row invoive-info">
                <div class="col-md-4 col-xs-12 invoice-client-info">
                  ...
                  <h6 class="m-0"><?php echo $obj_invoices->name." ".$obj_invoices->last_name;?></h6>
                ...
                <div class="col-md-4 col-sm-6">
                  ...
                  <table class="table table-responsive invoice-table invoice-order table-borderless">
                    <tbody>
                      <tr>
                         <th>Patrocinador :</th>
                        <td>#<?php echo $obj_invoices->customer_id;?></td>
                      </tr>
                      <tr>
                         <th>Nombre :</th>
                        <td><?php echo $obj_invoices->first_name." ".$obj_invoices->last_name;?></td>
                      </tr>
                      <tr>
                         <th>Usuario :</th>
                        <td><?php echo $obj_invoices->username;?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
          ...
          <div class="row text-center">
            <div class="col-sm-12 invoice-btn-group text-center">
                <button type="button"  onclick="back_list_enlace_compra();" class="btn btn-secondary m-b-10 ">Regresar</button></div>
          </div>
        </div>
      </div>
    </div>
